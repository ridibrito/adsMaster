...
export default function FaqCanva() {
            ...
            <div>
              ...
              >
                <h3 className="flex items-center mb-4 text-lg font-medium text-gray-400 ">
                  ...
                  Qual o formato do curso Canva Pró?
                </h3>
                <div style={{ display: open1 ? "block" : "none" }}>
                  <p className=" text-gray-400">
                    Você irá receber imediatamente após o seu pagamento, o
                    acesso ao curso em VÍDEO e materiais editáveis pelo canva.
                  </p>
                </div>
              </div>
              <div
              ...
              >
                <h3 className="flex items-center mb-4 text-lg font-medium text-gray-400 ">
                  ...
                  Acesso ao treinamento e Pack
                </h3>
                <div style={{ display: open5 ? "block" : "none" }}>
                  <p className=" text-gray-400">
                    Assim, que seu pedido for aprovado você recebe em seu e-mail
                    um link de acesso ao conteúdo, onde você será direcionado
                    para sua área do aluno.
                  </p>
                </div>
              </div>
